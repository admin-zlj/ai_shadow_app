...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-dvh w-full max-w-full flex-col items-center justify-center overflow-hidden bg-zinc-950 px-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <label className="flex flex-col gap-1.5 text-sm text-zinc-300">
            ...
            <input
              ...
              className="rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-base text-zinc-50 outline-none focus:border-zinc-500"
              placeholder="admin"
            />
          </label>
          <label className="flex flex-col gap-1.5 text-sm text-zinc-300">
